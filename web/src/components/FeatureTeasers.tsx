...
const teasers: Teaser[] = [
  ...
  { icon: "💧", title: "Money Leaks", desc: "Where to stop spending: forgotten subscriptions, bank fees and surcharges, categories creeping up month after month, duplicate charges, and weekend impulse patterns — with a monthly recoverable total. Free — PRO adds a written summary." },
