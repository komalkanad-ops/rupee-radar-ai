...
import { splitsRouter } from "./modules/splits/splitsRouter.js";
...
import { couponRouter } from "./modules/coupons/couponRouter.js";
...
import { proPurchaseRouter } from "./modules/billing/proPurchaseRouter.js";
...
import { betaTesterRouter } from "./modules/betaTester/betaTesterRouter.js";
import { mailWebhookRouter } from "./modules/mailWebhook/mailWebhookRouter.js";
...
app.use("/pro-purchase", proPurchaseRouter);
...
app.use("/beta-tester-requests", betaTesterRouter);
app.use("/webhooks/hostinger-mail", mailWebhookRouter);
